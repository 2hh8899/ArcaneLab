            ...
            update: function() {
                if (!this.pramaEffect) {
                    ...
                    if (this.blockElement) {
                        this.effects.sheet.spawnOnTarget("effect" + hR[this.blockElement], this, {
                            duration: -1
                        });
                    }
                }
    ...
    .defines(function() {
        ...
        ig.ENTITY.LaserTurret = ig.AnimatedEntity.extend({
            ...
            createLaser: function() {
                if (this.dir == 1) {
                    ...
                    this.laserEntity = ig.game.spawnEntity(sc.LaserPuzzleEntity, a.x + 24, a.y, this.coll.pos.z + 13.5, {});
        ...
        sc.LaserPuzzleEntity = ig.AnimatedEntity.extend({
            ...
            handleMovementTrace: function(a) { //벽 포함 반응
                if (!this._killed && !this.phaseMode && a.collided && !this.stopEntity.entity) {
                    this.setLaserTrail();
            ...
            shoot: function(a) {
                ...
                this.combatant.party = sc.COMBATANT_PARTY.OTHER;
        ...
        sc.LaserPuzzleTrail = ig.AnimatedEntity.extend({
            ...
            spawnEffect: function(a, b) {
                this.effects.perma = this.effects.sheet.spawnOnTarget("laser" + b, this, {
                    duration: -1,
                    target2: a
                });
            },
